...
import { DummySketch } from './components/dummy-sketch'
...
function Hero() {
  return (
    <section className="hero-stage mb-20 sm:mb-28">
      <DummySketch />
      ...
      <h1 className="display rise-2 text-foreground" style={{ fontSize: 'clamp(4.5rem, 14vw, 9rem)' }}>
        Build<br />
        <em className="serif italic italic-stroke">anyway.</em>
      </h1>
      ...
      <section className="mb-20 sm:mb-28">
        ...
        <div className="prose-essay">
          <p className="drop-cap">
            ...
            backlog of product ideas who still feel sidelined because they
            never picked up code. The premise stays sharp: AI dropped the
            barrier, the desire to build remains.
          </p>

          <p>
            The name comes from that familiar pit-in-the-stomach moment —
            walking into a room fluent in APIs and frameworks and feeling
            like the dummy in the corner. I&rsquo;m not interested in
            pretending that feeling isn&rsquo;t real; I&rsquo;m interested
            in turning it into an identity for people who build anyway.
          </p>

          <p>
            Litigators, brand leads, operations chiefs, controllers —
            anyone who knows their craft cold and still gets told they need
            an engineer in the room. I&rsquo;m one of you. I sit in finance
            and tax. I&rsquo;ve been quietly stitching together AI tools at
            my day job, learning as I go, and I want to sit with others
            doing the same.
          </p>

          <p>
            Phase 1 is an interview series. I talk with people about the
            prompts they fought to perfect, the scrappy tooling they
            assembled, the choices they made when the off-the-shelf option
            fell short. No pitch. No service. Just the story of how they
            work.
          </p>

          <p>
            Later comes a hackathon for builders without engineering
            titles. Further out, something closer to a YC for non-technical
            founders — a place where someone with an idea and no
            engineering background can bring it to life with AI.
          </p>
  ...
  return (
    <Reveal>
      ...
      <section className="pt-2">
        ...
        <div className="prose-essay">
          <p>
            I&rsquo;d love to talk to you. 30 minutes, on a call, recorded
            with your sign-off. I publish the conversation as a written
            piece so others in the same boat can learn from how you work.
          </p>
          <p>
